            ...
            <div class="email-container">
              ...
              <div class="content">
                ...
                <div style="text-align: center;">
                  <a href="${process.env.DOMAIN || "https://secureaegix.com"}/dashboard" class="cta-button">
                ...
                <div style="margin-top: 40px; text-align: center;">
                  ...
                  <p style="margin-top: 10px;">
                    ...
                    🌐 <a href="${process.env.DOMAIN || "https://secureaegix.com"}" class="contact-link">Visit Our Website</a>
                  </p>
                </div>
              </div>
              ...
              <div class="footer">
                ...
                <div class="contact-info">
                  <p>📍 Delhi, India<br>
                  📧 <a href="mailto:info@secureaegix.com" class="contact-link">info@secureaegix.com</a><br>
                  🔗 <a href="${process.env.DOMAIN || "https://secureaegix.com"}" class="contact-link">secureaegix.com</a></p>
                </div>
